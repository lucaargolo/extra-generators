...
object BlockEntityCompendium: RegistryCompendium<BlockEntityType<*>>(Registry.BLOCK_ENTITY_TYPE) {
    ...
    val ITEM_GENERATOR_TYPE = register("item_generator", BlockEntityType.Builder.create( { ItemGeneratorBlockEntity() }, BlockCompendium.FURNACE_GENERATOR, BlockCompendium.CULINARY_GENERATOR, BlockCompendium.FROSTY_GENERATOR ).build(null)) as BlockEntityType<ItemGeneratorBlockEntity>
